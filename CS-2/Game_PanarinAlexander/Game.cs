...
namespace Game_PanarinAlexander
{
    ...
    */
    static class Game
    {
        ...
        static int countAsteriods = 3;
        static Ship _ship = new Ship(new Point(10, 400), new Point(5, 5), new Size(10, 10)); // корабль
        static FirstAidKit _firstAidKit; // аптечка
        ...
        {
            if (e.KeyCode == Keys.ControlKey) _bullets.Add(new Bullet(new Point(_ship.Rect.X + 10, _ship.Rect.Y + 4), new Point(10, 0), new Size(4, 1)));
        ...
        public static void Load()
		{
			...
			GetAsteroids(countAsteriods);
		}

		private static List<Asteroid> GetAsteroids(int n)
		{
            _asteroids = new List<Asteroid>(n);

            for (var i = 0; i < n; i++)
			{
				int r = random.Next(10, 30);
				_asteroids.Add(new Asteroid(new Point(-Width, random.Next(10, Height)), new Point(r / 5, r), new Size(r, r)));
			}
            return _asteroids;
		}
		...
		public static void Draw()
        {
            ...
            foreach (Bullet b in _bullets) b.Draw(); // Пуля
        ...
        public static void Update()
        {
            ...
            for (var i = 0; i < _asteroids.Count; i++)
            {
                ...
                // уничтожение пули и астероида при столкновении
                ...
                if (i < 0 || _asteroids[i] == null)
                    continue;

                // повреждение корабля при столкновении с астероидом
